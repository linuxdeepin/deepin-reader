...
const QString sAppName = QObject::tr("deepin-reader");
...
//const QString sThumbnailTitle = QObject::tr(":/resources/image/normal/thumbnail.svg");
const QString sThumbnailTitle = QObject::tr("thumbnail");    //  标题栏注释图标
