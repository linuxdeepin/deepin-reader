    ...
    : CustomWidget(parent)
{
    ...
    //modify by guoshaoyu
    m_findLabel = new DLabel(tr("Find"));
    m_editLine = new LineBar();
    m_findNextButton = new DPushButton(tr("Next"));
    m_findPrevButton = new DPushButton(tr("Previous"));
    ...
    connect(m_findNextButton, &DPushButton::clicked, this, &FindBar::findNext, Qt::QueuedConnection);
    connect(m_findPrevButton, &DPushButton::clicked, this, &FindBar::findPrev, Qt::QueuedConnection);
...
int FindBar::dealWithData(const int &, const QString &)
{
    return 0;
}

void FindBar::initWidget()
{
