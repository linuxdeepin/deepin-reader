...
static QString LEFT_SLIDERBAR_WIDGET = "LeftSidebarWidget";
...
static QString MAIN_TAB_WIDGET = "MainTabWidgetEx";
static QString MAIN_TAB_BAR = "MainTabBar";
static QString MAIN_SPLITTER = "MainSplitter";
