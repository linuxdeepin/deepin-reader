...
SheetBrowserPDFLMenu::SheetBrowserPDFLMenu(QWidget *parent) : DMenu(parent)
{
    DFontSizeManager::instance()->bind(this, DFontSizeManager::T6);
}

void SheetBrowserPDFLMenu::initActions(DocSheet *docsheet, int index, DocSheetMenuType_e type)
{
    if (type == DOC_MENU_ANNO_ICON) {
        ...
        if (index == docsheet->pagesNumber() - 1) {
...
QAction *SheetBrowserPDFLMenu::createAction(const QString &displayname, const QString &objectname)
{
...
void SheetBrowserPDFLMenu::onItemClicked()
{
    emit signalMenuItemClicked(sender()->objectName());
}

void SheetBrowserPDFLMenu::onSetHighLight(const int &colorIndex)
{
