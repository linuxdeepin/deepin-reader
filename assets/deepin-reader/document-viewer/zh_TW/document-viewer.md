# 文件查看器|../common/deepin_reader_96.svg|
...
3. 右鍵單擊 ![deepin_reader_24](../common/deepin_reader_24.svg)，您可以：
 ...
 - 點擊 **開機啟動**，將應用程式添加到開機啟動項，在電腦開機時自動執行該應用。
   ...
   > ![tips](../common/tips.svg)竅門：您可以在控制中心中將文件查看器設定為預設的文件查看程式，具體操作請參考 [預設程式設定](dman:///dde#預設程式設定)。
...
- 右鍵單擊文件，選擇 **用其他程式開啟 > 選擇預設開啟程式**，在程式列表中選擇文件查看器開啟。
   ...
   > ![tips](../common/tips.svg)竅門：直接雙擊文件會使用預設程式開啟文件，您可以右鍵單擊文件，在 **屬性 > 用其他程式開啟** 中選擇一個預設程式，也可以到控制中心 [預設程式](dman:///dde#預設程式) 中去設定此類文件的全域預設程式。
