# 文檔查看器|../common/deepin_reader_96.svg|
...
3. 右鍵單擊 ![deepin_reader_24](../common/deepin_reader_24.svg)，您可以：
 ...
 - 單擊 **加至開機啟動**，將應用程序添加到開機啟動項，在電腦開機時自動運行該應用。
   ...
   > ![tips](../common/tips.svg)竅門：您可以在控制中心中將文檔查看器設置為默認的文檔查看程序，具體操作請參考 [默認程序設置](dman:///dde#默認程序設置)。
...
- 右鍵單擊文件，選擇 **打開方式 > 選擇默認程序**，在程序列表中選擇文檔查看器打開。
   ...
   > ![tips](../common/tips.svg)竅門：直接雙擊文件會使用默認程序打開文件，您可以右鍵單擊文件，在 **屬性 > 打開方式** 中選擇一個默認程序，也可以到控制中心[默認程序設置](dman:///dde#默認程序設置)中去設置此類文件的全局默認程序。
...
- 在文檔查看器界面工具列中，單擊 **+** 放大或 **-** 縮小 。
- 在工具列中手動輸入縮略比例，或在下拉框選擇：10%、25%、50%、75%、100%、125%、150%、175%、200%、300%、400%、500%，文檔跟着比例依次放大縮小。
...
2. 選擇 **在檔案管理員中顯示**，打開並定位該文件存放在文件夾的位置。
